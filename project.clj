(defproject csv-pie "0.1.0"
  ...
  {:builds [{:id           "app"
             ...
             ;; :figwheel {:on-jsload "csv-pie.core/on-figwheel-reload"}

             :compiler     {:main                 csv-pie.core
                            :asset-path           "js/compiled/out"
                            :output-to            "resources/public/js/compiled/csv_pie.js"
  ...
  :profiles
  {:dev     {:dependencies [[figwheel "0.5.4-4"]
